		...
		<div class="col-md-6">
			...
			<?php 
				...
				?>
						...
						<td style=" border: 1px solid #dddddd;text-align: left;padding: 8px;"><?php echo  ($selling_status==1)?"Sold Out" : "Available"; ?></td>
						...
						<?php
						     ...
						     <td style=" border: 1px solid #dddddd;text-align: left;padding: 8px;"><a href="soldpost.php?post_id=<?php echo $post_ids; ?>"><button class="btn btn-success">View</button></a></td>
			...
			<div class="jumbotron">
				...
				<form action="post_an_ad.php" method="post" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" name="title" value="<?php echo isset($post_titless) ? $post_titless : ''; ?>" class="form-control" required placeholder="Enter post title">
					</div>
					<div class="form-group">
						<label for="">Price</label>
						<input type="text" name="price" value="<?php echo isset($post_price) ? $post_price : ''; ?>" class="form-control" required placeholder="Enter price">
					</div>
					<div class="form-group">
						<label for="">Contact No</label>
						<input type="text" name="mobile" value="<?php echo isset($post_contact) ? $post_contact : ''; ?>" class="form-control" required placeholder="Enter your contact">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" name="location" required value="<?php echo isset($post_location) ? $post_location : ''; ?>" class="form-control" placeholder="Enter your location">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea class="form-control" required name="post_content" placeholder="Product details..." id="" cols="20" rows="5"><?php if (isset($post_details)) {
							echo $post_details;
						} ?></textarea>
					</div>
