 	...
 	while ($rwwwpp = mysqli_fetch_assoc($result)) {
 		...
 		while ($row1 = mysqli_fetch_assoc($results)) {
 			...
 			<div class="sidedsn">
				...
				<div class="row">
					<div class="col-md-3">
						<img style="max-width: 45px;max-height: 45px;border-radius: 100%; border:2px solid black;margin-top:3px;margin-right: 7px;" src="assets/img/<?php echo $two_photo; ?>" alt="">
					</div>
					<div class="col-md-9">
                        ...
                        $query = "SELECT * FROM massage WHERE sender_id = $post_user_id AND reciever_id = $qry_id OR sender_id = $qry_id AND reciever_id = $post_user_id";
                            ...
                            if ($result) {
                                while ($row = mysqli_fetch_assoc($result)) {
									...
									<div class="receiver">
                                     <div class="row mb-3">
										<div class="col-md-2">
											<div class="img-box">
						                    	<img style="height:50px; width:50px; border-radius:100%" src="assets/img/<?php echo $pics; ?>" alt="">
								...
								<div class="row">
									...
									<div class="col-md-2">
										<div class="img-box">
					                    	<img style=" height:50px; width:50px; border-radius:100%" src="assets/img/<?php echo $user_cht_phto; ?>" alt="">
