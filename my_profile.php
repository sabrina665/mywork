                    ...
                    <div class="col-md-5 offset-md-1" style="border-right: 5px solid #d6d2d2;">
                        <div class="lft_side">
                            ...
                            <div class="basic_details">
                                ...
                                <p><i class="fa fa-phone"></i> <?php echo $user_phone; ?></p>
                                ...
                                $limit=0;
                                    ...
                                    $rtng_query = "SELECT * FROM orders WHERE seller_email = '$vsting_user_email' AND confirm_status = 1 OR buyer_email = '$vsting_user_email' AND confirm_status = 1 ";
                                    ...
                                    if ($rtng_query_rslt) {
                                        ...
                                        if ($rating_num>0 && $rating_num<=5) {
                                           $limit=1; 
										   $level="1st level user";
                                        }
                                        if ($rating_num>5 && $rating_num<=10) {
                                           $limit=2; 
										   $level="2nd level user";
                                        }
                                        if ($rating_num>10 && $rating_num<=15) {
                                           $limit=3; 
										   $level="3rd level user";
                                        }
                                        if ($rating_num>15 && $rating_num<=30) {
                                           $limit=4; 
										   $level="4th level user";
                                        }
                                        if ($rating_num>30) {
										   $level="5th level user";
                                           $limit=5; 
                                        }
                                ...
                                <?php 
                                    if ($_SESSION['u_l']==true && $post_user_id !=$_SESSION['user_id']) {
										?>
									    <br>
                                        <a href="messenger.php?rsvr_id=<?php echo $post_user_id; ?>"><button class="btn btn-success" type="button">Massage</button></a>
                                        <br><br>
                                    <?php 
								    }
                    ...
                    <div class="col-md-5 offset-md-1">
                       <div class="right_side">
                        ...
                        <?php 
                            ...
                            $count_post_query1 = "SELECT * FROM orders WHERE seller_email = '$visiting_user_email' AND confirm_status= 1 ";
                            $cnt_rs1 = mysqli_query($connection,$count_post_query1);

                            $cnt_rs_rw1 = mysqli_num_rows( $cnt_rs1);


                            $count_post_query2 = "SELECT * FROM orders WHERE buyer_email = '$visiting_user_email' AND confirm_status= 1";
