				...
				<div class="col-md-9">
					...
					<?php 
						...
						if (isset($_GET['post_id'])) {
							...
							$post_edit_query = "SELECT * FROM post WHERE post_id = $the_post_id AND post_status = 1 AND selling_status = 1";
					...
					<div class="row single-ad-item mb-3">
						<div class="col-md-12">
							<h3 style="font-family:arial" class="item-title"><?php echo $post_title; ?></h3>
							
						    <img style="float: right !important;height:100px;width:130px"src="assets/img/soldout.png" alt="Mobile">
							
							<h4 style="font-family:erial">
								...
								<span class="small mr-3"><strong>Condition :</strong> <?php echo $post_condition; ?></span><br>
							...
							<h3>Details :</h3>
							<p style="text-align:justify"><?php echo $post_details; ?></p>
